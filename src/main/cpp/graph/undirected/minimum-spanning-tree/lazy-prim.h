#ifndef ALGORITHMS_PRINCETON_UNDIRECTED_WEIGHTED_GRAPH_MINIMUM_SPANNING_TREE_PRIM_H_
#define ALGORITHMS_PRINCETON_UNDIRECTED_WEIGHTED_GRAPH_MINIMUM_SPANNING_TREE_PRIM_H_
