...
/*
 * Instead of finding a global minimum, Insertion works by comparing two adjacent items;
 ...
 * In summation, the name of the game is local swapping with adjacent items until the item belongs, 
 *  relative to the items left of the current index.
 */
