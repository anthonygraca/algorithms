#include <graph/undirected/minimum-spanning-tree/eager-prim.h>
...
TEST(LazyPrimMst, TinyEWG) {
  ...
  EXPECT_EQ(1, edges[1].either());
  EXPECT_EQ(7, edges[1].other(1));
  EXPECT_NEAR(0.19, edges[1].getWeight(), 0.01);
  EXPECT_EQ(0, edges[2].either());
  EXPECT_EQ(2, edges[2].other(0));
  EXPECT_NEAR(0.26, edges[2].getWeight(), 0.01);
  EXPECT_EQ(2, edges[3].either());
  EXPECT_EQ(3, edges[3].other(2));
  EXPECT_NEAR(0.17, edges[3].getWeight(), 0.01);
